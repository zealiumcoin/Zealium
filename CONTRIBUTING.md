Contributing to Zealium
============================

The Zealium project operates an open contributor model where anyone is
...
The following applies to code changes to the Zealium project, and is not to be
confused with overall Zealium Network Protocol consensus changes.

Whether a pull request is merged into Zealium rests with the project merge
...
Patches that change Zealium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zealium consensus, it must have been
...
The project leader is the release manager for each Zealium release.
