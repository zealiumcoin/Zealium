...
RESOURCES += src/qt/zealium.qrc src/qt/zealium_locale.qrc

TRANSLATIONS += src/qt/locale/zealium_bg.ts \
                src/qt/locale/zealium_de.ts \
                src/qt/locale/zealium_en.ts \
                src/qt/locale/zealium_es.ts \
                src/qt/locale/zealium_fi.ts \
                src/qt/locale/zealium_fr.ts \
                src/qt/locale/zealium_it.ts \
                src/qt/locale/zealium_ja.ts \
                src/qt/locale/zealium_pl.ts \
                src/qt/locale/zealium_pt.ts \
                src/qt/locale/zealium_ru.ts \
                src/qt/locale/zealium_sk.ts \
                src/qt/locale/zealium_sv.ts \
                src/qt/locale/zealium_vi.ts \
                src/qt/locale/zealium_zh_CN.ts \
                src/qt/locale/zealium_zh_TW.ts
