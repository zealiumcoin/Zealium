...
In order to support loading of multiple wallets in zealium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zealium.cpp.
...
Changes to zealium.cpp
----------------------
zealium.cpp is the entry point into zealium-qt, and as such, will require some minor modifications to provide hooks for
