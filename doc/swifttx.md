...
This mechanism has been integrated into Bitcore-Node-Zealium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Zealium-Project/insight-api-zealium#web-socket-api](https://github.com/Zealium-Project/insight-api-zealium#web-socket-api) 
* API: [https://github.com/Zealium-Project/insight-api-zealium#swifttx-transactions](https://github.com/Zealium-Project/insight-api-zealium#swifttx-transactions) 
...
By default, the Zealium daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zealium daemon:
