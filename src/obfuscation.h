...
{
public:
    /// Is the inputs associated with this public key? (and there is 4000 NZL - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of zealium.
