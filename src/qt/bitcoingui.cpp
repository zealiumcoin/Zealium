                                                                            ...
                                                                            nWeight(0)
{
    ...
    QString windowTitle = tr("Zealium") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zealium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zealium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zealium"), this);
    aboutAction->setStatusTip(tr("Show information about Zealium"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zealium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zealium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zealium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zealium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zealium help message to get a list with possible Zealium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zealium client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zealium network", "", count));
}
...
{
    QString strTitle = tr("Zealium"); // default title
