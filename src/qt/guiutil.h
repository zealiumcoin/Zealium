...
/** Utility functions used by the Zealium Qt UI.
 */
namespace GUIUtil
{
...
// Render Zealium addresses in monospace font
...
// Parse "zealium:" URI into recipient object, return true on successful parsing
