...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Zealium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zealium features */
        {"zealium", "masternode", &masternode, true, true, false},
        {"zealium", "listmasternodes", &listmasternodes, true, true, false},
        {"zealium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zealium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zealium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zealium", "masternodedebug", &masternodedebug, true, true, false},
        {"zealium", "startmasternode", &startmasternode, true, true, false},
        {"zealium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zealium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zealium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zealium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zealium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zealium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zealium", "mnbudget", &mnbudget, true, true, false},
        {"zealium", "preparebudget", &preparebudget, true, true, false},
        {"zealium", "submitbudget", &submitbudget, true, true, false},
        {"zealium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zealium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zealium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zealium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zealium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zealium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zealium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zealium", "checkbudgets", &checkbudgets, true, true, false},
        {"zealium", "mnsync", &mnsync, true, true, false},
        {"zealium", "spork", &spork, true, true, false},
        {"zealium", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zealium", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zealiumd, or the -server option to zealium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zealium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31091/\n";
}
